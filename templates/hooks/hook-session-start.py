...
"""
        ...
        # Factory AI SessionStart hook output
        # NOTE: SessionStart additionalContext goes to Droid context ONLY
        #       There is NO way to show visible output to user from SessionStart
        #       (This is by Factory AI design - docs confirm this)
        output = {
            "hookSpecificOutput": {
